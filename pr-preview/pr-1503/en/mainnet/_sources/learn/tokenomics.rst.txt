...
Transactions
============
To submit a :ref:`transaction <transactions>` to the blockchain, a :ref:`fee <transaction-fees>` must be paid in CCD. The price of transactions is fixed in EUR, not in CCD. This means that they are not subject to the fluctuations of CCD. Businesses can thus plan the cost of their operations.
...
.. image:: ../docs/protocol/images/tokenomics-diagram-updated.png
