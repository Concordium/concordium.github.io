...
Choose the method that works best for your setup, and follow the corresponding guide for detailed instructions.
...
You can open a pool during initial registration or add it later by updating your validator configuration. You will be guided to instructions about opening and managing a staking pool when following the setup guides above. If you run a staking pool, it is recommended to create a website with information about your pool and add the URL to your staking pool configuration — this helps potential delegators understand your goals. For frequently asked questions about staking pools and delegation, see :ref:`Delegation and validation FAQ<delegation-faq-old>`.

Next steps
==========

Once your validator is active, focus on maintaining reliable uptime and monitoring your validator's performance. Protect your validator keys, watch that you are not approaching the bounding cap for max capital, and subscribe to the `Mainnet status page <https://status.mainnet.concordium.software/>`_ and `release information on Discourse <https://support.concordium.software/c/releases/9>`_ to stay informed about node software releases and protocol updates.
