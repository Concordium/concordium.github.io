...
5. Select the recipient and select **Continue**.
   ...
   .. image:: ../../../docs/images/desktop-wallet/dw-send-ccd-schedule.png
      :alt: transaction screen with amount for scheduled transfer

Option 1: Create a regular interval schedule
--------------------------------------------

.. image:: ../../../docs/images/desktop-wallet/dw-send-ccd-regular-interval.png
...
.. image:: ../../../docs/images/desktop-wallet/dw-send-ccd-explicit-schedule1.png
        :width: 35%
        :alt: screen with amount for explicit transfer

.. image:: ../../../docs/images/desktop-wallet/dw-send-ccd-explicit-schedule2.png
         :width: 35%
