...
when :ref:`simulating contract functions locally<local-simulate-v0>`.
...
JSON Object containing the chain meta data, see :ref:`context-metadata-v0` for a
...
JSON array of the policies of the sender, see :ref:`context-sender-policy-v0` for a
reference a policy.
