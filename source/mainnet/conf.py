...
extlinks = {
    ...
    'cdw-sig': ('https://distribution.mainnet.concordium.software/tools/linux/concordium-desktop-wallet-1.7.3.%s.sig', 'Download signature:%s') # Supply extension, e.g. exe, dmg, AppImage
}
