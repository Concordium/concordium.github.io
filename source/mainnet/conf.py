...
extlinks = {
    ...
    'cdw-sig': ('https://distribution.mainnet.concordium.software/tools/linux/concordium-desktop-wallet-1.3.0.%s.sig', 'Download signature') # Supply extension, e.g. exe, dmg, AppImage
}
