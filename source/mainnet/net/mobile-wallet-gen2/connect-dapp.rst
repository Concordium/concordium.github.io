...
#. Click the scan QR code button in the Accounts overview (screenshot) or Transactions overview (screenshot). If you scan the QR code button in the Accounts overview, tap the account that you want to use to pay for services.
