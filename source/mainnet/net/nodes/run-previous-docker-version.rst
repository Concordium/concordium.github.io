...
.. _run-previous-docker-version:

=============================================
Run a node with previous Docker node versions
=============================================
...
.. Note::
   ...
   **The following information applies only to node versions prior to 4.2.3.**
...
2. Download and extract the appropriate node version.
...
stopped, reset, and started again. To reset the container either use
