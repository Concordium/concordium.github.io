...
.. dropdown:: Desktop Wallet
    ...
    Before you create more accounts, you need a LEDGER device with the Concordium LEDGER App installed. See :ref:`Set up the LEDGER device and install the Concordium LEDGER App<overview-desktop>`.
