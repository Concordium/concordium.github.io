...
.. dropdown:: Can I migrate from the |mw-gen1| to the |bw|?
    ...
    #. Download the |bw| and set it up so you have a secret recovery phrase, a verified identity, and at least one account.
    ...
    Note that in the near future identity and account creation will be disabled in |mw-gen1|.
