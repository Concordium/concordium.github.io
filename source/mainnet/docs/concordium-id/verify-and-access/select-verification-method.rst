...
This check verifies a user's identity directly against an official :term:`Identity Object` (like a passport or driver's license) that has been validated by an approved :term:`Identity Provider (IDP)<Identity Provider>`.
