...
.. admonition:: At a glance
   ...
   This page covers advanced configuration options for a Concordium node running on Windows, including verifying the node is running, enabling inbound connections, and TLS setup. You will need a running Windows node. Use this page when you need to go beyond the default setup.
