...
.. admonition:: At a glance
   ...
   This guide explains the role of a guardian in a Concordium governance election and how to complete all three phases: setup, voting, and tallying. You will need the CryptoX or Browser Wallet with the ability to export account keys, and access to the guardian application. After following this guide, you will have fulfilled your guardian responsibilities across the full election cycle.
