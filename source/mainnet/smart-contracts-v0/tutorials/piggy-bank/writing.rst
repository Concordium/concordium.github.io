...
This is the first :ref:`part of a tutorial<piggy-bank-v0>` on smart contract
...
Open ``src/lib.rs`` in your editor and you'll see some code for :ref:`writing tests<piggy-bank-testing-v0>`,
...
various :ref:`actions<action-descriptions-v0>`.
