...
that you have a :ref:`smart-contract module<setup-tools-v0>` ready to be deployed.
...
.. seealso::
   ...
   :ref:`initialize-contract-v0`.

   For more information about module references, see :ref:`references-on-chain-v0`.
