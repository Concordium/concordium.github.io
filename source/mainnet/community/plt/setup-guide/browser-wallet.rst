...
1. **Download the DevNet Browser Wallet**
   ...
   Download `Browser Wallet v2.2.13 <https://distribution.concordium.software/devnet/concordium-browser-wallet-2.2.13.zip>`_, the custom version that allows connection to DevNet.
