...
Once you've set up the Ledger, you must check that it's running the proper firmware version. The Concordium Ledger App currently only supports Ledger firmware version 2.1.0.
...
#. Press both buttons to view the **Secure Element** version. If it says **2.0.3**, you don’t have to update the firmware. If there’s a lower version number, you’ll have to update the firmware.
...
Once you have updated the firmware version, you can download the version of the Ledger app that is appropriate for the firmware at :ref:`Downloads <downloads>`. Follow the instructions below to update your app:
