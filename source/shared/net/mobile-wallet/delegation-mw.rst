...
.. Note::
   ...
   Before delegating any of your stake to a baker pool, use the :ref:`CCD scan tool<ccd-scan>` to research bakers and pools thoroughly.
...
.. toctree::
   :maxdepth: 1
   :caption: Delegation transactions

   add-delegation-mw
   update-delegation-mw
   remove-delegation-mw
