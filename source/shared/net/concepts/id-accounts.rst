...
You can create identities in the :ref:`Desktop Wallet <create-initial-account-desktop>` or in the :ref:`Make a backup of identities and accounts in the Mobile Wallet <export-import-mw>`. The |Net| release presently supports the Notabene identity issuance flow.
