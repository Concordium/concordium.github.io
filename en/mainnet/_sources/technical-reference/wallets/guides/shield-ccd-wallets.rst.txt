...
.. dropdown:: |cryptox|
    ...
    #. Tap **Unshield**.
        ...
        .. image:: ../../../docs/images/cryptoX/cryptox-unshield-funds1.png
            :width: 40%
    ...
    #. Tap **Unshield funds**
        ...
        .. image:: ../../../docs/images/cryptoX/cryptox-unshield-funds2.png
            :width: 40%
    ...
    #. Tap **Done, let's move on**.
        ...
        .. image:: ../../../docs/images/cryptoX/cryptox-unshield-funds3.png
            :width: 40%
...
.. dropdown:: Desktop Wallet
    ...
    #. Select **Shielded Balance** on the relevant account, and then select **Unshield**.
        ...
        .. image:: ../../../docs/images/desktop-wallet/dw-unshield.png

    #. Enter the amount of CCD that you want to unshield, and then select **Continue**.

        .. image:: ../../../docs/images/desktop-wallet/dw-unshield-ccd.png
    ...
    .. |more-acct| image:: ../../../docs/images/more-acct.png
        :alt: Button with double-headed arrow
        :width: 50px

    .. |acct-settings| image:: ../../../docs/images/acct-settings.png
                    :alt: gear wheel on blue background
                    :width: 50px

    .. |unshield-mw| image:: ../../../docs/images/unshield-mw.png
